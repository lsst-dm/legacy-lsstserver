#
#   coral 1_9_0+2 DarwinX86
#
m4_changequote([, ])m4_dnl
#
m4_define([m4_PACKAGE], [coral])m4_dnl
m4_define([m4_VERSION], [1_9_0+2])m4_dnl
...
m4_define([m4_TARBALL], [coral-1_9_0+2-DarwinX86.tar.gz])m4_dnl
# 
...
cd('$BUILDDIR')
shell('bash fixmeup.sh $THIRDPARTY_INSTALL/m4_PACKAGE m4_VERSION')
